                                        ...
                                        <div class="card-body">
                                            ...
                                            <form action="<?= base_url('forget'); ?>" method="POST">
                                                <div class="form-group" style="margin: 20px; margin-top: 0px;">
                                                    <label for="email"><sub>Email<span class="text-danger">*</span></sub></label>
                                                    <input type="email" name="email" id="email" placeholder="Enter Email" class="form-control">
                                                    <sub style="color: red;"><?php echo form_error('email'); ?></sub>
                                                </div>
                                                <div class="form-group" style="margin: 20px; margin-top: 0px;">
                                                ...
                                                <div class="form-group" style="margin: 20px; margin-top: 0px;">
                                                    ...
                                                    <a href="<?= base_url(); ?>" style="float: left;">Sign In</a>
