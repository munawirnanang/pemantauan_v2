...
(function(k){(function(f){
        ...
        t(k.lang,{printChart:"Print chart",
            ...
            downloadFull:"Full",
            contextButtonTitle:"Unduh Grafik"
        });
        k.navigation={
            buttonOptions:{
                theme:{},
        ...
        k.exporting={type:"image/png",
            ...
            buttons:{
              ...
              //      menuItems:"printChart separator downloadPNG downloadJPEG downloadPDF downloadSVG".split(" ")}
                //ok//    menuItems:" printChart separator downloadPNG downloadJPEG downloadPDF ".split(" ")
                menuItems:" printChart separator downloadPNG downloadJPEG downloadPDF ".split(" ")
                }
            },
            menuItemDefinitions:{
               ...
               // downloadFull:{textKey:"downloadFull",onclick:function(){this.exportChart({type:"application/pdf"})}},
